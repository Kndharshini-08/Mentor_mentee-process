...
$qrt=mysqli_query($connect,"select * from alumni where Uname='$sid'");
...
$max_qry = mysqli_query($connect,"select max(id) from friends");
	...
	$date=date("d-m-y");
	$t=$date.' / ' .date("h:i.a");
	$qrt=mysqli_query($connect,"insert into friends values('$id','$sid','$sname','','mentor','$message','$t')");
	if($qrt)
	{
...
<body style="height:1500px;overflow-y:hidden;background:#f0f2f5;">
...
<br />
 ...
 <form action="" method="post" name="form1" >
              ...
              <div align="center">
				...
				?>
                    ...
                    <tr>
                      ...
                      <td width="88%" style="font-weight:900;text-align:right;color:#CC0000">Me <img src="upload/<?php echo $cmr['image'];?>" style="width:50px;height:50px;border-radius:50%;margin-left:5px;border:2px solid black"></td>
					  </tr>
			...
			<?php	
                    ...
                    <tr>
                      <td width="12%" height="27"><i style='font-size:24px' class='fas'></i></td>
                      <td width="88%" style="font-weight:900;"><img src="upload/<?php echo $cmr['image'];?>" style="width:50px;height:50px;border-radius:50%;margin-right:5px;border:2px solid black">
					 
					  <?php echo $cm['sname'];?>-<?php echo $ssid;?>-<?php echo $cm['type'];?><?php
