...
if(isset($_POST['btn']))
{
$qry=mysqli_query($connect,"select * from register where name='$uname' && reg='$password'");
$num=mysqli_num_rows($qry);
if($num==1)
{
$qry1=mysqli_query($connect,"select * from register where name='$uname' && reg='$password'");
$row=mysqli_fetch_array($qry1);
$_SESSION['sid']=$row['Id'];
$_SESSION['sreg']=$password;
	   ...
	   <table width="50%" border="0" align="left">
		...
		<td width="41%">&nbsp;</td>
         ...
         <tr>
           ...
           <td height="31"align="right"><span class="style2"><strong>Student Name </strong></span></td>
           <td><label>
             <input name="uname" type="text" id="uname" />
           </label></td>
         </tr>
         <tr>
           <td height="44" align="right"><span class="style2"><strong>Register Number</strong></span></td>
           <td><label>
         ...
         <tr>
           ...
           <td rowspan="2"><label>
		    ...
		    <td width="21%" rowspan="2" align="center"> <a href="sregister.php">New Student Registration</a></td>
         </tr>
